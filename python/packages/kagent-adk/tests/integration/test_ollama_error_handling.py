...
class TestOllamaErrorHandling:
    ...
    async def test_model_not_found_404(self, ollama_base_url):
        ...
        ollama_native = OllamaNative(type="ollama", model="nonexistent-model-12345", base_url=ollama_base_url)
    ...
    async def test_connection_error_invalid_host(self):
        ...
        ollama_native = OllamaNative(type="ollama", model="llama2", base_url="http://invalid-host-12345:9999")
    ...
    async def test_streaming_error_handling(self, ollama_base_url):
        ...
        ollama_native = OllamaNative(type="ollama", model="nonexistent-streaming-model", base_url=ollama_base_url)
    ...
    async def test_error_response_structure(self, ollama_base_url):
        ...
        ollama_native = OllamaNative(type="ollama", model="bad-model", base_url=ollama_base_url)
