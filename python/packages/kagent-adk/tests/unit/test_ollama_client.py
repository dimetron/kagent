...
class TestOllamaNativeClient:
    ...
    def test_client_property_creates_async_client(self):
        ...
        ollama_native = OllamaNative(type="ollama", model="llama2", base_url="http://localhost:11434")
    ...
    def test_client_with_custom_host(self):
        ...
        ollama_native = OllamaNative(type="ollama", model="llama2", base_url=custom_url)
    ...
    def test_client_with_custom_headers(self):
        ...
        custom_headers = {"Authorization": "Bearer test-token", "X-Custom": "value"}

        ollama_native = OllamaNative(type="ollama", model="llama2", headers=custom_headers)
    ...
    def test_client_with_custom_timeout(self):
        ...
        ollama_native = OllamaNative(type="ollama", model="llama2", timeout=30.0)
    ...
    def test_multiple_instances_have_different_clients(self):
        ...
        ollama1 = OllamaNative(type="ollama", model="llama2", base_url="http://host1:11434")

        ollama2 = OllamaNative(type="ollama", model="mistral", base_url="http://host2:11434")
    ...
    def test_model_name_stored(self):
        ...
        model_name = "llama2"
        ollama_native = OllamaNative(type="ollama", model=model_name)
...
class TestOllamaAPIBaseEnvVar:
    ...
    def test_explicit_base_url_overrides_env_var(self, monkeypatch):
        ...
        ollama_native = OllamaNative(type="ollama", model="llama2", base_url=explicit_url)
