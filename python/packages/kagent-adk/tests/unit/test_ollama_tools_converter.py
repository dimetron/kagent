            ...
            Tool(
                function_declarations=[
                    FunctionDeclaration(
                        ...
                        parameters=Schema(
                            type="object",
                            properties={"location": Schema(type="string", description="City name")},
                            required=["location"],
                        ),
                    )
                ]
                    ...
                    FunctionDeclaration(
                        ...
                        parameters=Schema(
                            ...
                            properties={
                                ...
                                "data": Schema(
                                    type="object",
                                    properties={"name": Schema(type="string"), "age": Schema(type="integer")},
                                ),
                            },
                        ),
                    )
            ...
            Tool(
                function_declarations=[
                    FunctionDeclaration(
                        ...
                        parameters=Schema(
                            type="object", properties={"items": Schema(type="array", items=Schema(type="string"))}
                        ),
                    )
                ]
            )
            ...
            Tool(
                function_declarations=[
                    FunctionDeclaration(
                        ...
                        parameters=Schema(
                            type="object",
                            properties={"mode": Schema(type="string", enum=["fast", "balanced", "accurate"])},
                        ),
                    )
                ]
            )
    ...
    def test_multiple_function_declarations(self):
        ...
        tools = [
            Tool(
                function_declarations=[
                    FunctionDeclaration(
                        name="func1", description="First function", parameters=Schema(type="object", properties={})
                    ),
                    FunctionDeclaration(
                        name="func2", description="Second function", parameters=Schema(type="object", properties={})
                    ),
                ]
            )
        ]
            ...
            Tool(
                function_declarations=[
                    FunctionDeclaration(
                        ...
                        parameters=Schema(
                            type="object",
                            properties={"param1": Schema(type="string", description="This is parameter 1")},
                        ),
                    )
                ]
            )
