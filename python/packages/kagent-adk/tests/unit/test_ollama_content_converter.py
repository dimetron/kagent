...
class TestConvertContentToOllamaMessages:
    ...
    def test_function_call_conversion(self):
        ...
        contents = [
            ...
            types.Content(
                role="model",
                parts=[types.Part(function_call=FunctionCall(name="get_weather", args={"location": "Paris"}))],
            ),
        ]
    ...
    def test_function_response_conversion(self):
        ...
        contents = [
            ...
            types.Content(
                ...
                parts=[
                    types.Part(
                        function_call=FunctionCall(id="call_123", name="get_weather", args={"location": "Paris"})
                    )
                ],
            ),
            types.Content(
                ...
                parts=[
                    types.Part(
                        function_response=FunctionResponse(
                            id="call_123", name="get_weather", response={"temperature": 20, "condition": "sunny"}
                        )
                    )
                ],
            ),
        ...
        contents = [
            types.Content(
                ...
                parts=[
                    ...
                    types.Part(inline_data=types.Blob(mime_type="image/jpeg", data=b"fake_image_data")),
                ],
            )
        ]
    ...
    def test_multiple_function_calls(self):
        ...
        contents = [
            types.Content(
                role="model",
                parts=[
                    types.Part(function_call=FunctionCall(id="call_1", name="get_weather", args={"location": "Paris"})),
                    types.Part(function_call=FunctionCall(id="call_2", name="get_time", args={"timezone": "UTC"})),
                ],
            )
        ]
    ...
    def test_function_call_with_complex_nested_args(self):
        ...
        complex_args = {
            "user": {
                "name": "John",
                "address": {"street": "123 Main St", "city": "Paris", "coordinates": {"lat": 48.8566, "lng": 2.3522}},
            },
            "options": ["email", "sms"],
            "count": 42,
        }
        ...
        contents = [
            types.Content(
                ...
                parts=[
                    types.Part(
                        function_call=FunctionCall(id="call_complex", name="send_notification", args=complex_args)
                    )
                ],
            )
        ]
