...
import (
	...
	"github.com/kagent-dev/kagent/go/pkg/app/auth"
	"github.com/kagent-dev/kagent/go/pkg/app/config"
	apperrors "github.com/kagent-dev/kagent/go/pkg/app/errors"
	"github.com/kagent-dev/kagent/go/pkg/app/session"
	"github.com/kagent-dev/kagent/go/pkg/app/tools"
)

// App represents the main KAgent application
type App struct {
	Config          *Config
...
// NewApp creates a new KAgent application
