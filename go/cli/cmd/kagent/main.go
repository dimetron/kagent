...
import (
	...
	"github.com/kagent-dev/kagent/go/cli/internal/cli/adk"
...
Examples:
  ...
  kagent run .`,
	...
	rootCmd.AddCommand(installCmd, uninstallCmd, invokeCmd, bugReportCmd, versionCmd, dashboardCmd, getCmd, initCmd, buildCmd, deployCmd, addMcpCmd, runCmd, mcp.NewMCPCmd(), adk.NewADKCmd())
