...
const ToolDisplay = ({ call, result, status = "requested", isError = false, isDecided = false, subagentName, onApprove, onReject, tokenStats, mcpApp, onMcpAppSendMessage, onMcpAppVisibleToolCall }: ToolDisplayProps) => {
          ...
          {shouldRenderMcpApp && (
            <div className="isolate w-full overflow-visible">
              <McpAppRenderer
                ...
                onVisibleToolCall={onMcpAppVisibleToolCall}
              />
            </div>
          )}
        </div>
